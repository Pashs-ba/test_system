...
## Панель управления
**Все таблицы системы управление сортируемы**
### Управление юзерами
...
*Вы можете ввести только один ответ, система диалогов все еще находится в разработке*
...
Внутренняя админ-панель находится по стандартному адресу в Django.

## Ученикам
## Соревнования
![](/screenshots/students/student_copm.png)
Вид страницы соренований зависит от его типа (вот [здесь](#управление-соревнованиями) все описанно)
